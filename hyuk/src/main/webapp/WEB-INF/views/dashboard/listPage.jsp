				...
				<div class="row">
	                  ...
	                  <div class="col-md-12">
	                  	  ...
	                  	  <div class="content-panel">
	                			  ...
	                			  <a href="/dashboard/registerboard"><button class= "btn btn-theme02" type="button">등록 버튼 </button></a>	  
						
		                      <table class="table">
		              
		                      <button  class= "btn btn-theme03" type="submit">삭제 버튼 </button>
		                          <thead>
			                          <tr>
		                         ...
		                         <c:forEach items="${list}" var="boardDTO" >
			                          <tr>
			                          	<td> ${boardDTO.bno}</td>
			                          	<td><a href="/dashboard/viewboard?bno=${boardDTO.bno}">${boardDTO.title}</a></td>
				...
				<div class="text-center">
					<ul class="pagination">
						<c:if test="${pageMaker.prev}">
							<li><a href="listPage?page=${pagaMaker.startPage-1}">&laquo;</a></li>
						</c:if>
