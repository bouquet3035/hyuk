               ...
               <button  class= "board btn btn-theme03" type="sumit">돌아가기 </button>
                  	   <br></br>
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input name= "title" type="text" class="form-control" readonly="readonly" value="${boardDTO.title}">
                                  </input>
                              </div>
                          </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input  name= "contents" type="text"  size="50"class="form-control" readonly="readonly" value='${boardDTO.contents}'/>
                              </div>
                          </div>
